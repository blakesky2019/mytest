...
public interface MessageConstant {
    ...
    static final String EDIT_PERMSSION_SUCCESS = "编辑权限成功";
    static final String EDIT_ROLE_SUCCESS = "编辑角色成功";
    static final String EDIT_MENU_SUCCESS = "编辑菜单成功";
    static final String EDIT_UDER_SUCCESS = "编辑用户成功";
    ...
    static final String DELETE_PERMSSION_SUCCESS = "删除权限成功";
    ...
    static final String SEND_VALIDATECODE = "请先发送验证码";
    ...
    static final String GET_PERMISSION_SUCCESS = "获取权限信息成功";
    ...
    static final String NOT_SEND_CODE ="请点击发送二维码" ;
}
