...
public class QiNiuUtil {
    ...
    private static final String ACCESSKEY = "r7Bl-V83CfnYwqBvkg28PZFopMWbJAicg0ZQb70i";
    private static final String SECRETKEY = "kb_ucPW73k7BZBbItywDai5iMom34dHJ1LGK4_Ob";
    private static final String BUCKET = "day59-day68-health-image";
    public static final String DOMAIN= "pyc5n9bio.bkt.clouddn.com";

   /* public static void main(String[] args) {
        uploadFile("E:\\计算机资料\\项目一.传智健康\\day62\\day04\\sadd.png","sad.jpg");
